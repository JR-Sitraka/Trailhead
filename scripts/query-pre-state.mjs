...
async function main() {
  const sid = await sql`SELECT id FROM symbols WHERE "repository_id" = '0aa69121-92ad-4750-af26-97ccbd3dbf2a' ORDER BY id LIMIT 5`;
  ...
  const scount = (await sql`SELECT count(*) c FROM symbols WHERE "repository_id" = '0aa69121-92ad-4750-af26-97ccbd3dbf2a'`)[0].c;
